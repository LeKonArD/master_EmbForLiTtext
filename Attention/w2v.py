...
## fill these with paths
traindata = ""
testdata = ""

model_w2v = KeyedVectors.load_word2vec_format("/home/ext/konle/master/german.model", binary=True, unicode_errors="ignore")
...
def generate_embeddings_eval(batch_size):
  ...
  while True:
    ...
    for index, row in data.iterrows():
        ...
        for tok in my_sent:
           if tok == "<named_entity>":
                t_embed.append(model_w2v["name"])
           try:
                t_embed.append(model_w2v[tok])
           except:
                t_embed.append(model_w2v["unbekannt"])
